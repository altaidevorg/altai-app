...
| Order | Package | Status | Depends on | Planned PRs | Acceptance gate |
| ---: | --- | --- | --- | ---: | --- |
| 070 | ExternalObject model and GitHub adapter | in_progress | 051, 060 | #809, #810 | Idempotent sync, explicit authority and conflict resolution |
...
1. `CP-08-63` — ExternalObject model and GitHub adapter
   (Package 070 PR 3: the GitHub provider over the desktop HTTP client) or 068 PR 2.
