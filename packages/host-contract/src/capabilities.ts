...
export const DEFAULT_CAPABILITY_MATRIX: readonly CapabilityEntry[] = [
  ...
  { id: "runtime.startRun", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.steerRun", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.cancelRun", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.retryRun", availability: "deferred", note: "Requires interactive parity (TASK-011)" },
  { id: "runtime.queueRun", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.compactContext", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.replayRun", availability: "deferred", note: "Requires agent-service parity (TASK-005)" },
  { id: "runtime.shutdown", availability: "available" },
  { id: "runtime.events", availability: "deferred", note: "Requires event bridge over host transport" },
  ...
  { id: "interactive.permissionModes", availability: "deferred", note: "Requires settings + run start wiring" },
  { id: "interactive.permissionBypass", availability: "deferred", note: "Requires explicit confirmation flow" },

  { id: "sessions.list", availability: "deferred", note: "Requires TASK-005" },
  { id: "sessions.get", availability: "deferred", note: "Requires TASK-005" },
  { id: "sessions.create", availability: "deferred", note: "Requires TASK-005" },
  ...
  { id: "sessions.messages", availability: "deferred", note: "Requires TASK-005" },

  { id: "models.list", availability: "deferred", note: "Requires models/list host method" },
